...
[1] = LAYOUT(
   KC_ESC, KC_TILD, KCS_1,  KCS_2,   KCS_3,   KCS_4,   KCS_5,      XXXXXXX, CD_LEFT, KC_UP,   CD_RGHT, KC_PGUP, XXXXXXX, RGUI_T(KC_BSLS),
           CTR_CPS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,      XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, XXXXXXX,
           KC_LSFT, KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,
                                   KC_LGUI, XXXXXXX, KC_LALT,      KC_RALT, XXXXXXX, RESET
),

[2] = LAYOUT(
   KC_ESC, KC_TILD,KC_PGUP,CD_LEFT,  KC_UP, CD_RGHT, XXXXXXX,      KCS_6,  KCS_7,   KCS_8,   KCS_9,  KCS_0,    XXXXXXX,  RGUI_T(KC_BSLS),
           CTR_CPS,KC_PGDN,KC_LEFT,KC_DOWN, KC_RGHT, XXXXXXX,      KC_6,    KC_7,    KC_8,    KC_9,   KC_0,    XXXXXXX,
           KC_LSFT,XXXXXXX,XXXXXXX,XXXXXXX, XXXXXXX, XXXXXXX,      KC_F6,  KC_F7,   KC_F8,   KC_F9, KC_F10,     KC_F11,
                                     RESET, XXXXXXX, KC_LALT,      KC_RALT, XXXXXXX, KC_DEL
),
