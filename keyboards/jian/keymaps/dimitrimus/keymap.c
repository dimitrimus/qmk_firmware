...
[0] = LAYOUT(
  KC_GESC,  KC_TAB, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, RGUI_T(KC_RBRC),
...
[1] = LAYOUT(
  KC_GESC, KC_TILD, KCS_1,  KCS_2,   KCS_3,   KCS_4,   KCS_5,    KC__VOLUP, CD_LEFT, KC_UP,   CD_RGHT, KC_PGUP, XXXXXXX, RGUI_T(KC_BSLS),
...
[2] = LAYOUT(
  KC_GESC, KC_TILD,KC_PGUP,CD_LEFT,  KC_UP, CD_RGHT, KC__VOLUP,    KCS_6,  KCS_7,   KCS_8,   KCS_9,  KCS_0,    XXXXXXX,  RGUI_T(KC_BSLS),
